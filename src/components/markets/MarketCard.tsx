    ...
    <article className="card group overflow-hidden relative flex flex-col">
      ...
      <div className="relative h-48 bg-gradient-to-br from-slate-200 to-slate-300 overflow-hidden">
        ...
        <div className="absolute top-3 left-3">
          <span className="badge bg-white/90 text-slate-800 text-xs font-bold shadow-sm">
        ...
        {market.featured && (
          <div className="absolute top-3 right-3">
            <span className="badge bg-[#22C55E] text-white text-xs shadow-sm">⭐ Featured</span>
          </div>
        )}

        {/* Crowd level */}
        <div className="absolute bottom-3 left-3">
          <span className={`badge text-xs shadow-sm ${crowdColor[eveningCrowd]}`}>
      ...
      <div className="p-4 flex flex-col flex-1">
        <div className="flex items-start justify-between mb-2">
          <h2 className="font-bold text-[#0F172A] text-base leading-tight group-hover:text-[#22C55E] transition-colors">
            {market.name}
          </h2>
            ...
            <button
              ...
              className={`text-xs px-2.5 py-1.5 rounded-lg font-medium transition-all border ${
                inCompare
                  ...
                  : canAdd
                  ? 'bg-white text-slate-600 border-slate-200 hover:border-[#22C55E] hover:text-[#22C55E]'
